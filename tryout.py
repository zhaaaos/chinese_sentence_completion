...
# TOKEN_EMBEDDING_DIMENSION = 390 # The dimention of vector representing a token
# SEQUENCE_LENGTH = 139  # the length of input sequence
# BATCH_SIZE = 100
...
# mhead_att1.load_state_dict(torch.load("./the_transformer_text_gen_modelv5_dataset2_v2_390_139_4x_6_3_1e04.pth"))
